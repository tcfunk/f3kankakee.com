...
f3k3 theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of f3k3 theme and run the following commands:
`nvm use`
...
`drush en f3k3 -y`
`drush config-set system.theme default f3k3 -y`
